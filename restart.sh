...
docker run -it --rm --name redis-master -v ${PWD}/master/redis.conf:/etc/redis.conf \
...
docker run -it --rm --name redis-slave -v ${PWD}/slave/redis.conf:/etc/redis.conf \
...
docker run -it --rm --name redis-sentinel -v ${PWD}/sentinel/sentinel.conf:/etc/sentinel.conf \
